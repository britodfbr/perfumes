...
PagSeguro.prototype.atualizaCarrinho = function() {
  ...
  ret += '<input type=button onclick="window.location.reload( true );" value="Limpar" alt="Limpar todos os itens da compra! :( " >'
  ret += '<input type=button onclick="parentNode.submit()" value="Finalizar" alt="Finalizar compra! " >\n'
