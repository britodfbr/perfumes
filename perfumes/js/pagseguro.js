...
PagSeguro.prototype.atualizaCarrinho = function() {
  ...
  ret += '<input type=button onclick=window.location.assign("http://www.perfumes.incolume.com.br/#vitrinemenu"); value="Limpar Todos" alt="Limpar todos os itens da compra! :( " >'
