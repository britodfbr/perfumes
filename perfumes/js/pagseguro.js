...
PagSeguro.prototype.atualizaCarrinho = function() {
  ...
  ret += '<input type=button onclick=window.location.replace("http://www.perfumes.incolume.com.br/#vitrinemenu");window.location.reload( true ); value="Limpar Todos" alt="Limpar todos os itens da compra! :( " >'
